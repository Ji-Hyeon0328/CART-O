...
# B100 HY/KN SIGN PROBE OVERRIDES
...
args.b99_print = True
print('[B100 CONFIG] HY/KN sign probe: B70 DLS gain=0, direct HY/KN cases during protected pulse; B91/B74/B75/B76 muted')
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B100 HY/KN SIGN PROBE HIND + B99/B98 recovery planner")
