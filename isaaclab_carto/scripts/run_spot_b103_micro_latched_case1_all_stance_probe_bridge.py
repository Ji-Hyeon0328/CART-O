...
# B103 MICRO LATCHED CASE-1 ALL-STANCE HY/KN SIGN PROBE OVERRIDES
...
args.enable_b102_all_stance_direct_hykn_sign_probe = True
...
print('[B103 CONFIG] micro latched all-stance case-1 HY/KN probe: start=800 delta=0.006 case_steps=6 safe gating, q-latched baseline')
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B103 MICRO LATCHED CASE-1 ALL-STANCE HY/KN SIGN PROBE planner")
