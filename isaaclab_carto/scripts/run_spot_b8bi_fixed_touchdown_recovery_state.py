...
#
# B8-bi: fixed touchdown recovery state machine.
#
...
parser = argparse.ArgumentParser(description="CARTO/TRACER B8-bi fixed touchdown recovery state machine")
...
def print_debug(step, phase, profile, phase_step, x_hat, base_ref, trial_out, ref_mask, contact_mask,
    ...
    print("\n" + "=" * 150)
    print(f"[B8-bi FIXED-TOUCHDOWN-RECOVERY-STATE] step={step}")
    print("=" * 150)
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B8-bi fixed touchdown recovery state machine")
    ...
    for step in range(total_steps):
        ...
        touchdown_recovery_target, touchdown_recovery_delta_full, touchdown_recovery_info = apply_touchdown_stance_recovery_target(
            robot, previous_swing_stance_q_ref, previous_swing_leg, touchdown_recovery_active, touchdown_load_hold_count
        )
