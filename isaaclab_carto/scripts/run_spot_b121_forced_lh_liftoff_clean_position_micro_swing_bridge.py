...
print('[B121 CONFIG] forced LH liftoff + clean hind position-only micro-swing: B70+B98, no raw torque')
...
args.b10_allow_liftoff_on_b10_gate = True
args.b10_relocation_target_err_tol = 999.0
args.b10_relocation_geom_margin_tol = -999.0
args.b10_relocation_min_shift_steps = 0
args.b10_print = True
args.canonical_liftoff_min_margin = -999.0
args.canonical_liftoff_margin_relaxed = -999.0
args.canonical_liftoff_allow_after_shift_steps = 0
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B121 FORCED LH LIFTOFF CLEAN POSITION-ONLY MICRO-SWING planner")
