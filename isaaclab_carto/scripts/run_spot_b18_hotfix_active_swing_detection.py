...
#
# B18-hotfix: committed foothold pinning with active-swing detection fix.
#
...
parser = argparse.ArgumentParser(description="CARTO/TRACER B18-hotfix active swing detection")
...
def _b18_print_post_capture_geometry(step, x_hat, foot_pos, cfg, device, dtype, label=""):
    ...
    for name in _b17_parse_leg_list(args.b17_foothold_next_candidates):
        try:
            ...
            pass
    print("[B18-HOTFIX POST-CAPTURE GEOMETRY]", "step=", step, "label=", label, "rows=", rows)
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B18-hotfix committed foothold pinning with active-swing detection fix")
    ...
    for step in range(total_steps):
        ...
        if args.enable_canonical_gait_schedule and args.canonical_gait_disable_event_overrides:
            ...
            if args.b18_print and b18_commit_info.get("active", False):
                print("[B18-HOTFIX FOOTHOLD COMMIT]",
                      "step=", step,
        ...
        try:
            ...
            if args.b18_print and (step % max(args.print_every, 1) == 0):
                print("[B18-HOTFIX FOOTHOLD PIN ERROR]", "step=", step, "err=", repr(_e))
                        ...
                        try:
                            ...
                            if bool(b18_committed_valid[_leg_tmp]):
                                ...
                                if args.b18_print:
                                    ...
                                    print("[B18-HOTFIX POST-CAPTURE PIN START]",
                                          "step=", step,
