...
# B117: remove implicit actuator PD as much as possible for raw effort authority audit.
# B116 showed action_sent_to_env is correct, but applied_torque is dominated by implicit actuator/drive torque.
args.pd_scale = 0.0
args.enable_b15_recenter_fallback = False
args.enable_b16_recenter_all_stance_pd_alignment = False
print('[B117 ZERO IMPLICIT PD] pd_scale=', args.pd_scale, 'b15=', bool(getattr(args, 'enable_b15_recenter_fallback', False)), 'b16=', bool(getattr(args, 'enable_b16_recenter_all_stance_pd_alignment', False)))
...
args.b114_start_step = 120
args.b114_case_steps = 12
args.b114_gap_steps = 30
args.b114_cases = 'HY-2,KN-2;HY+2,KN+2;HY-5,KN-5;HY+5,KN+5;HY-5,KN+5;HY+5,KN-5'
...
print('[B117 ZERO IMPLICIT PD ACTION AUDIT PROBE] leg=', args.b114_probe_leg, 'start=', args.b114_start_step, 'case_steps=', args.b114_case_steps, 'gap_steps=', args.b114_gap_steps, 'cases=', args.b114_cases)
...
def _b114_raw_effort_override(robot, tau_cmd, foot_pos, step):
    ...
    if bool(getattr(args, 'b114_zero_hx', True)):
        tau_new[0, int(joint_ids[0])] = 0.0
    if bool(getattr(args, 'b114_override_hykn', True)):
        tau_new[0, int(joint_ids[1])] = float(hy_tau)
        tau_new[0, int(joint_ids[2])] = float(kn_tau)
    else:
        tau_new[0, int(joint_ids[1])] += float(hy_tau)
        tau_new[0, int(joint_ids[2])] += float(kn_tau)
...
def _b114_print_info(step, info, robot):
    ...
    try:
        ...
        applied = None
    print('[B117 ACTION PATH AUDIT PRE]',
          'step=', step,
...
def _b116_print_post_step(step, pre_info, action_sent, robot):
    ...
    print('[B117 ACTION PATH AUDIT POST]',
          'step=', step,
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B117 ZERO-IMPLICIT-PD ACTION AUDIT RAW EFFORT PROBE (ALL-STANCE, LH HY/KN OVERRIDE) planner")
    ...
    for step in range(total_steps):
        ...
        try:
            ...
            print('[B117 ACTION PATH AUDIT ERROR]', 'step=', step, 'err=', repr(_b114_e))
            b116_action_sent_to_env = tau_cmd.detach().clone()
        ...
        try:
            ...
            print('[B117 ACTION PATH AUDIT POST ERROR]', 'step=', step, 'err=', repr(_b116_post_e))
