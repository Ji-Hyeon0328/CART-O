...
parser.add_argument("--b77_hind_swing_duration_steps", type=int, default=34)
parser.add_argument("--b77_hind_min_duration_steps", type=int, default=18)
parser.add_argument("--b77_max_base_ref_xy_err", type=float, default=0.080)
parser.add_argument("--b77_min_trial_margin", type=float, default=0.020)
parser.add_argument("--b77_max_abs_roll", type=float, default=0.120)
parser.add_argument("--b77_max_abs_pitch", type=float, default=0.120)
parser.add_argument("--b77_min_base_z", type=float, default=0.620)
parser.add_argument("--b77_hind_gap_after_touchdown", type=int, default=260)
...
parser.add_argument("--b78_recovery_steps", type=int, default=360)
parser.add_argument("--b78_recovery_gap_steps", type=int, default=360)
...
parser.add_argument("--b79_posture_max_delta", type=float, default=0.08)
parser.add_argument("--b79_posture_kp", type=float, default=42.0)
parser.add_argument("--b79_posture_kd", type=float, default=3.0)
parser.add_argument("--b79_posture_max_tau", type=float, default=22.0)
parser.add_argument("--b79_boost_base_kp_xy", type=float, default=55.0)
parser.add_argument("--b79_boost_base_kd_xy", type=float, default=16.0)
parser.add_argument("--b79_boost_base_z", type=float, default=85.0)
parser.add_argument("--b79_boost_rp", type=float, default=75.0)
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B80 STRONG RECOVERY STAND TAKEOVER + B78/B77/B76/B75/B74 planner")
