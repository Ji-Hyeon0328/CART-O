# isaaclab_carto/scripts/run_spot_b8ai_swing_leg_torque_assist.py
#
# B8-ai: No-align decoupled pre-shift + swing-leg torque assist for full-WBC.
#
...
def print_debug(step, phase, profile, phase_step, x_hat, base_ref, trial_out, ref_mask, contact_mask,
    ...
    print("\n" + "=" * 150)
    print(f"[B8-ai SWING-LEG-TORQUE-ASSIST] step={step}")
    print("=" * 150)
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B8-ai swing-leg torque assist")
