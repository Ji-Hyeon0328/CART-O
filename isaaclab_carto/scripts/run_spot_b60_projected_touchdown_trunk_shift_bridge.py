...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B60 projected touchdown-aware trunk shift + B59c/B58/B57/B56b/B49/B48 planner")
    ...
    for step in range(total_steps):
        ...
        if 'b56_tau_assist' in locals() and isinstance(b56_safe_info, dict) and b56_safe_info.get("active", False) and not (('b57_arc_info' in locals()) and isinstance(b57_arc_info, dict) and b57_arc_info.get("active", False)):
