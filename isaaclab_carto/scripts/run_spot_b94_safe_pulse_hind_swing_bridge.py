...
# B94 SAFE-PULSE HIND SWING OVERRIDES
# B93 proved that a long, deep release is unstable.  B94 makes the release
# shallow and very short, and explicitly hands control from B78/B79 recovery
# back to the normal LH swing stack when the pulse starts.
...
print('[B94 CONFIG] safe pulse hind swing: shallow unload, 12-step release pulse, B78/B79 disabled during pulse')
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B94 SAFE-PULSE HIND SWING + B93/B92/B90 recovery planner")
