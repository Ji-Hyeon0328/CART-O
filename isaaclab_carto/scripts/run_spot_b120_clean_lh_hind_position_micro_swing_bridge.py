...
print('[B120 CONFIG] clean LH hind-leg position-only micro-swing: B70+B98, no raw torque, no compensation')
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B120 CLEAN LH HIND POSITION-ONLY MICRO-SWING planner")
