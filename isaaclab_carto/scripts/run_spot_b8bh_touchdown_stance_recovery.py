...
#
# B8-bh: touchdown stance recovery after foothold.
#
...
parser = argparse.ArgumentParser(description="CARTO/TRACER B8-bh touchdown stance recovery after foothold")
...
def print_debug(step, phase, profile, phase_step, x_hat, base_ref, trial_out, ref_mask, contact_mask,
    ...
    print("\n" + "=" * 150)
    print(f"[B8-bh TOUCHDOWN-STANCE-RECOVERY] step={step}")
    print("=" * 150)
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B8-bh touchdown stance recovery after foothold")
