...
# B107 CORRECTED JACOBIAN HY-/KN- LIFT PULSE OVERRIDES
...
args.b93_hold_after_release_steps = 12
...
args.b99_print = True
print('[B107 CONFIG] corrected B70 Jacobian columns (joint_id+6) + HY-/KN- micro-lift; B91/B74/B75/B76 muted')
