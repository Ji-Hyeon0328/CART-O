...
# B68: isolate which swing assist layer drives LH/RH HY/lateral escape.
...
parser.add_argument("--b68_profile", type=str, default="b21off_b57pos_b62hxonly",
                    choices=["b21off_b57pos_b62hxonly", "b21off_b57pos_b62off", "b21off_b57pos_b20off_b62hxonly", "wbc_only"],
                    help="B68 isolation profile for LH/RH active-swing assist conflicts.")
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B68 swing-assist isolation probe + B67/B66/B65/B64/B63/B62/B61/B60/B59c planner")
