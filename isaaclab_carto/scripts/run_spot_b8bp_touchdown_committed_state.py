...
#
# B8-bp: touchdown committed state.
#
...
parser = argparse.ArgumentParser(description="CARTO/TRACER B8-bp touchdown committed state")
...
def print_debug(step, phase, profile, phase_step, x_hat, base_ref, trial_out, ref_mask, contact_mask,
    ...
    print("\n" + "=" * 150)
    print(f"[B8-bp TOUCHDOWN-COMMITTED-STATE] step={step}")
    print("=" * 150)
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B8-bp touchdown committed state")
