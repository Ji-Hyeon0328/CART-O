...
#
# B8-ap: Upright stable baseline + controlled forced release + Jacobian-IK swing adapter.
#
...
parser = argparse.ArgumentParser(description="CARTO/TRACER B8-ap upright stable forced release + Jacobian-IK swing adapter")
...
def print_debug(step, phase, profile, phase_step, x_hat, base_ref, trial_out, ref_mask, contact_mask,
    ...
    print("\n" + "=" * 150)
    print(f"[B8-ap UPRIGHT-FORCED-RELEASE-JACOBIAN-IK] step={step}")
    print("=" * 150)
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B8-ap upright stable forced release + Jacobian-IK swing adapter")
