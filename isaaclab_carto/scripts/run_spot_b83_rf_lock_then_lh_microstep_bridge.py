...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B83 RF-LOCK THEN LH MICRO-STEP + B82/B81/B80 recovery planner")
    ...
    for step in range(total_steps):
        ...
        if args.enable_canonical_gait_schedule and args.canonical_gait_disable_event_overrides:
            ...
            if bool(getattr(args, "enable_b78_true_all_stance_recovery", True)) and int(b78_recovery_count) > 0:
                if bool(getattr(args, "enable_b79_latched_recovery_posture", True)) and b79_recovery_base_ref is not None and bool(getattr(args, "b79_latch_base_ref_xy", True)):
        ...
        if ('b79_recovery_q_cmd' in locals() and b79_recovery_q_cmd is not None
            ...
            tau_b79 = torch.clamp(tau_b79, -float(args.b79_posture_max_tau), float(args.b79_posture_max_tau))
