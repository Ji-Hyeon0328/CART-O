...
print('[B122 CONFIG] pre-shifted LH liftoff + clean hind position-only micro-swing: B39/B11 shift -> B70/B98, no raw torque')
...
args.b10_print = True
args.canonical_liftoff_min_margin = -0.030
args.canonical_liftoff_margin_relaxed = -0.040
args.canonical_liftoff_allow_after_shift_steps = 260
...
# B122 final support-pre-shift override.  Keep swing stack clean, but restore the
# minimum trunk/base-reference relocation needed before LH liftoff.
# This is the opposite of B121: no diagnostic gate bypass.
args.enable_b89_disable_b38_relocation_alignment = False
args.enable_b11_wbc_relocation_task = True
args.b11_reloc_kp_base_xy = 65.0
args.b11_reloc_kd_base_xy = 14.0
args.b11_reloc_w_base_acc = 65.0
args.b11_reloc_w_stance_acc = 155.0
args.b11_reloc_max_base_acc_lin = 1.6
args.enable_b12_pd_target_alignment = False
args.enable_b38_candidate_support_recenter = False
args.enable_b39_latched_support_recenter = True
args.b39_candidate_legs = 'LH'
args.b39_force_shift_even_if_future_bad = True
args.b39_max_step = 0.0012
args.b39_target_err_tol = 0.052
args.b39_geom_margin_tol = -0.030
args.b39_min_shift_steps = 260
...
args.canonical_shift_hold_when_ref_error = True
args.canonical_shift_max_base_ref_xy_err = 0.045
args.canonical_shift_max_step = 0.0010
args.canonical_shift_blend = 1.0
args.canonical_shift_forward_bias = 0.0
args.canonical_shift_lateral_bias = 0.018
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B122 PRE-SHIFTED LH LIFTOFF CLEAN POSITION-ONLY MICRO-SWING planner")
