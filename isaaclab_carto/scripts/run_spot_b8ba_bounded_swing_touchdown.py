...
#
# B8-ba: bounded visible swing + real touchdown gate.
#
...
parser = argparse.ArgumentParser(description="CARTO/TRACER B8-ba bounded visible swing + real touchdown gate")
...
def print_debug(step, phase, profile, phase_step, x_hat, base_ref, trial_out, ref_mask, contact_mask,
    ...
    print("\n" + "=" * 150)
    print(f"[B8-ba BOUNDED-SWING-TOUCHDOWN] step={step}")
    print("=" * 150)
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B8-ba bounded visible swing + real touchdown gate")
    ...
    for step in range(total_steps):
        ...
        if phase in ["shift", "settle", "warmup", "done"] or late_touchdown:
            # pre-shift / settle / warmup / late-touchdown keep all contacts
            swing_enabled = False
