...
# B96 B95-PULSE-AS-ACTIVE-SWING OVERRIDES
# B95 proved that the safe pulse and forced footref are created, but B70 rejected
# the phase because b23_info["reason"] was "b95_forced_pulse_active_swing".
# B96 keeps the same pulse/footref but presents it to B70 as a normal
# "active_swing" phase, while preserving a debug field with the B95 origin.
args.enable_b94_safe_pulse_hind_swing = True
args.b93_unload_steps = 300
args.b93_min_unload_alpha = 0.50
args.b93_release_alpha = 0.58
args.b93_min_unload_steps = 220
args.b93_hold_after_release_steps = 12
args.b93_min_future_margin = -0.090
args.b93_w_force_track = 12.0
args.b93_w_stance_acc = 18.0
args.b93_w_base_acc = 14.0
args.b93_kp_base_xy = 5.0
args.b93_kd_base_xy = 2.5
args.b93_kp_base_z = 90.0
args.b93_kd_base_z = 16.0
args.b93_kp_base_rp = 95.0
args.b93_kd_base_rp = 18.0
args.b94_abort_base_z = 0.635
args.b94_abort_roll = 0.085
args.b94_abort_pitch = 0.085
# B95: keep the B94 pulse shallow, but long enough for B70 to show a visible
# tiny motion.  Safety abort still closes contact immediately if body drops/tilts.
args.enable_b95_forced_hind_pulse_footref = True
args.b95_forward_step = 0.014
args.b95_lateral_step = 0.000
args.b95_lift_step = 0.026
args.b95_sigma = 0.16
args.b95_use_base_yaw = True
args.b95_print = True
args.b93_hold_after_release_steps = 18
print('[B96 CONFIG] B95 forced hind pulse footref is presented to B70 as active_swing')
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B96 B95-PULSE-AS-ACTIVE-SWING + B94/B93/B92 recovery planner")
        ...
        try:
            ...
            if _b95_active:
                ...
                if bool(getattr(args, "b95_print", True)) and (step == b95_pulse_start_step or step % max(args.print_every, 1) == 0):
                    print("[B96/B95 FORCED HIND PULSE FOOTREF]",
                          "step=", step,
                ...
                if bool(getattr(args, "enable_b95_forced_hind_pulse_footref", False)) and b95_pulse_leg is not None:
                    if bool(getattr(args, "b95_print", True)) and step % max(args.print_every, 1) == 0:
                        print("[B96/B95 FORCED HIND PULSE FOOTREF END]", "step=", step, "leg=", ID_TO_LEG.get(int(b95_pulse_leg), b95_pulse_leg))
                b95_pulse_leg = None
                b95_pulse_anchor_w = None
                b95_pulse_target_w = None
                b95_pulse_start_step = -1
            ...
            if bool(getattr(args, "b95_print", True)) and step % max(args.print_every, 1) == 0:
                print("[B96/B95 FORCED HIND PULSE FOOTREF ERROR]", "step=", step, "error=", repr(_b95_e))
