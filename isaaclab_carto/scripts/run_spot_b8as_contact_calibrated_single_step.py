...
#
# B8-as: contact-calibrated warmup + RF single-step probe.
#
...
parser = argparse.ArgumentParser(description="CARTO/TRACER B8-as contact-calibrated warmup + RF single-step probe")
...
def print_debug(step, phase, profile, phase_step, x_hat, base_ref, trial_out, ref_mask, contact_mask,
                ...
                old_forced, controlled_forced, calib_status, contact_ready_seen):
    leg = LEG_TO_ID[args.test_leg]
    ...
    print("\n" + "=" * 150)
    print(f"[B8-as CONTACT-CALIBRATED-SINGLE-STEP] step={step}")
    print("=" * 150)
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B8-as contact-calibrated warmup + RF single-step probe")
