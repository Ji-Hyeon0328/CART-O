...
parser = argparse.ArgumentParser(description="CARTO/TRACER B8-bl real swing commit state")
...
def print_debug(step, phase, profile, phase_step, x_hat, base_ref, trial_out, ref_mask, contact_mask,
    ...
    print("\n" + "=" * 150)
    print(f"[B8-bl REAL-SWING-COMMIT-STATE] step={step}")
    print("=" * 150)
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B8-bl real swing commit state")
    ...
    for step in range(total_steps):
        ...
        if step_idx >= 1 and phase in ["lift", "hold_lift", "lower"]:
            ...
            if _margin_now < float(args.second_shift_requires_margin):
                swing_enabled = False
