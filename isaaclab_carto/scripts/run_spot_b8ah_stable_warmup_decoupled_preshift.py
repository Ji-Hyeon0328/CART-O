...
#
# B8-ah: Stable warmup + decoupled pre-shift gate for full-WBC.
#
...
def print_debug(step, phase, profile, phase_step, x_hat, base_ref, trial_out, ref_mask, contact_mask,
    ...
    print("\n" + "=" * 150)
    print(f"[B8-ah STABLE-WARMUP-DECOUPLED-PRESHIFT] step={step}")
    print("=" * 150)
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B8-ah stable-warmup decoupled pre-shift")
