...
#
# B8-bf: explicit foothold walk attempt.
#
...
parser = argparse.ArgumentParser(description="CARTO/TRACER B8-bf explicit foothold walk attempt")
...
def print_debug(step, phase, profile, phase_step, x_hat, base_ref, trial_out, ref_mask, contact_mask,
    ...
    print("\n" + "=" * 150)
    print(f"[B8-bf EXPLICIT-FOOTHOLD-WALK] step={step}")
    print("=" * 150)
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B8-bf explicit foothold walk attempt")
    ...
    for step in range(total_steps):
        ...
        if late_touchdown and args.foothold_accept_on_late_touchdown:
            # Accept the actual foot pose as new stance and remove residual IK target bias.
