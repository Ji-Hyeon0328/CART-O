...
print('[B123 CONFIG] relaxed pre-shift LH liftoff + clean hind position-only micro-swing: stronger B39/B11 shift -> B70/B98, no raw torque')
...
args.canonical_liftoff_margin_relaxed = -0.070
args.canonical_liftoff_allow_after_shift_steps = 320
...
args.canonical_executed_swing_duration_steps = 90
args.canonical_executed_swing_min_duration_steps = 40
...
args.b39_geom_margin_tol = -0.070
args.b39_min_shift_steps = 320
...
if bool(getattr(args, 'b70_print', False)):
    print('[B123 FINAL RELAXED PRE-SHIFT]',
