...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B93 FORCE-TRACK DOMINANT STABLE HIND SWING + B92/B90 recovery planner")
    ...
    for step in range(total_steps):
        ...
        try:
            if int(b92_release_hold_count) > 0 and b92_release_leg is not None:
                ...
                canonical_exec_info["gate_reason"] = "b92_controlled_unload_release"
                ...
                canonical_exec_info["gate_reason"] = "b92_controlled_unload_release_start"
                if bool(getattr(args, "b92_print", True)):
                    print("[B92 CONTROLLED UNLOAD RELEASE]",
                          "step=", step,
