...
#
# B8-ax: fast RF touchdown + auto-selected second leg.
#
...
parser = argparse.ArgumentParser(description="CARTO/TRACER B8-ax fast RF touchdown + auto-selected second leg")
...
def print_debug(step, phase, profile, phase_step, x_hat, base_ref, trial_out, ref_mask, contact_mask,
    ...
    print("\n" + "=" * 150)
    print(f"[B8-ax FAST-TOUCHDOWN-AUTO-SECOND] step={step}")
    print("=" * 150)
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B8-ax fast RF touchdown + auto-selected second leg")
