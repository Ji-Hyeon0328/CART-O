...
#
# B8-am: Crouched nominal stance + unload diagnostic.
#
...
parser = argparse.ArgumentParser(description="CARTO/TRACER B8-am crouched stance + unload diagnostic")
...
def print_debug(step, phase, profile, phase_step, x_hat, base_ref, trial_out, ref_mask, contact_mask,
                ...
                swing_anchor_step, crouch_delta_full, crouch_target, crouch_ramp):
    leg = LEG_TO_ID[args.test_leg]
    ...
    print("\n" + "=" * 150)
    print(f"[B8-am CROUCHED-STANCE-UNLOAD] step={step}")
    print("=" * 150)
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B8-am crouched stance + unload diagnostic")
