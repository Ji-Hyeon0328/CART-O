...
#
# B8-an: Crouched stance + Jacobian-IK swing adapter.
#
...
parser = argparse.ArgumentParser(description="CARTO/TRACER B8-an crouched stance + Jacobian-IK swing adapter")
...
def print_debug(step, phase, profile, phase_step, x_hat, base_ref, trial_out, ref_mask, contact_mask,
    ...
    print("\n" + "=" * 150)
    print(f"[B8-an CROUCHED-JACOBIAN-IK-SWING] step={step}")
    print("=" * 150)
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B8-an crouched stance + Jacobian-IK swing adapter")
