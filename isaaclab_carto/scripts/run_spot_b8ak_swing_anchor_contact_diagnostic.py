...
#
# B8-ak: Stable B8-ah rollback + swing anchor/contact diagnostic.
#
...
parser = argparse.ArgumentParser(description="CARTO/TRACER B8-ak swing anchor/contact diagnostic")
...
def print_debug(step, phase, profile, phase_step, x_hat, base_ref, trial_out, ref_mask, contact_mask,
    ...
    print("\n" + "=" * 150)
    print(f"[B8-ak SWING-ANCHOR-CONTACT-DIAG] step={step}")
    print("=" * 150)
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B8-ak swing anchor/contact diagnostic")
