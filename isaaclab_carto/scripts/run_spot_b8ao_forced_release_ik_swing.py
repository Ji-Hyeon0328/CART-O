...
#
# B8-ao: Crouched stance + controlled forced release + Jacobian-IK swing adapter.
#
...
parser = argparse.ArgumentParser(description="CARTO/TRACER B8-ao controlled forced release + Jacobian-IK swing adapter")
...
# B8-ao: controlled forced release gate.
parser.add_argument("--controlled_force_release", action="store_true")
parser.add_argument("--force_release_after_phase_step", type=int, default=260)
parser.add_argument("--force_release_max_abs_roll", type=float, default=0.18)
parser.add_argument("--force_release_max_abs_pitch", type=float, default=0.18)
...
def print_debug(step, phase, profile, phase_step, x_hat, base_ref, trial_out, ref_mask, contact_mask,
    ...
    print("\n" + "=" * 150)
    print(f"[B8-ao FORCED-RELEASE-JACOBIAN-IK-SWING] step={step}")
    print("=" * 150)
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B8-ao controlled forced release + Jacobian-IK swing adapter")
