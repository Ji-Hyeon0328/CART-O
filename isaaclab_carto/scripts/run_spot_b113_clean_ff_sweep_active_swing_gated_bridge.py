...
args.b99_print = True
print('[B112 CONFIG] clean 4-case HY/KN feedforward torque sign sweep: recovery disabled; PD torque bypassed; q-target/B98 off; logs case/tau_ff/foot response')
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B113 CLEAN FF TORQUE SIGN SWEEP (ACTIVE-SWING GATED, NO RECOVERY, NO PD, Q-TARGET OFF) planner")
