...
args.b98_max_hy_delta = 0.008
args.b98_max_kn_delta = 0.008
args.b98_print = True
...
args.b99_print = True
print('[B108 CONFIG] corrected B70 Jacobian columns (joint_id+6) + HY-/KN- micro-lift + small B70 torque assist; B91/B74/B75/B76 muted')
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B99 PURE VERTICAL LIFT ISOLATION + B98/B97 recovery planner")
