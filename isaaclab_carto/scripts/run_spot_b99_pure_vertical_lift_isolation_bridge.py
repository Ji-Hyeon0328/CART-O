...
# B99 PURE VERTICAL LIFT ISOLATION OVERRIDES
...
args.b93_min_future_margin = -0.090
...
args.b94_abort_base_z = 0.645
args.b94_abort_roll = 0.070
args.b94_abort_pitch = 0.070
...
args.b99_print = True
print('[B99 CONFIG] pure vertical-lift isolation: B70+B98 only during forced pulse; B91/B74/B75/B76 muted')
