...
args.b99_print = True
print('[B110 CONFIG] corrected joint_id+6 Jacobian + tiny q target + sign-fixed HY-/KN- feedforward torque; PD torque bypassed; logs tau_pd/tau_ff/tau_total')
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B110 SIGN-FIXED FEEDFORWARD HY-/KN- TORQUE PROBE planner")
