...
# B110: bypass PD torque and inject a sign-fixed, very short feedforward pulse.
...
args.b98_hy_z_gain = -0.80
args.b98_kn_z_gain = -0.80
args.b98_z_deadband = 0.002
args.b98_max_hy_delta = 0.004
args.b98_max_kn_delta = 0.004
args.b98_print = True
...
args.b99_print = True
print('[B111 CONFIG] clean sign-fixed HY-/KN- feedforward torque probe: B78/B79/B80 recovery disabled; PD torque bypassed; logs tau_pd/tau_ff/tau_total and B22 assist')
print('[B111 RECOVERY DISABLED] enable_b78=', bool(getattr(args, 'enable_b78_true_all_stance_recovery', False)), 'enable_b79=', bool(getattr(args, 'enable_b79_latched_recovery_posture', False)), 'b78_print=', bool(getattr(args, 'b78_print', False)), 'b79_print=', bool(getattr(args, 'b79_print', False)))
...
def _b70_minimal_clean_swing_adapter(robot, Jfeet_full, foot_pos_arg, b23_info, step):
    ...
    info = {
        ...
        "tau_pd": None, "tau_ff": None, "tau_total": None,
    }
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B111 CLEAN SIGN-FIXED FF TORQUE PROBE (NO B78/B79/B80 RECOVERY) planner")
