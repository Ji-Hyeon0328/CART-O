...
print('[B114 RAW EFFORT PROBE] leg=', args.b114_probe_leg, 'start=', args.b114_start_step, 'case_steps=', args.b114_case_steps, 'gap_steps=', args.b114_gap_steps, 'cases=', args.b114_cases)
...
def _b114_raw_effort_override(robot, tau_cmd, foot_pos, step):
    ...
    leg_id = LEG_NAME_TO_ID.get(leg_name, 2)
...
def _b114_print_info(step, info, robot):
    ...
    try:
        ...
        applied = None
    print('[B114 RAW EFFORT AUTHORITY]',
          'step=', step,
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B114 RAW EFFORT AUTHORITY PROBE (ALL-STANCE, LH HY/KN OVERRIDE) planner")
    ...
    for step in range(total_steps):
        ...
        try:
            ...
            print('[B114 RAW EFFORT ERROR]', 'step=', step, 'err=', repr(_b114_e))
