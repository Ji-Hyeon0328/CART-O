...
args.b70_max_joint_delta = 0.012
args.b70_max_hx_delta = 0.004
args.b70_max_hy_delta = 0.012
args.b70_max_kn_delta = 0.012
args.b70_err_scale_xy = 0.10
args.b70_err_scale_z = 0.40
args.b70_max_xy_err = 0.012
args.b70_max_z_err = 0.030
...
args.b70_apply_torque_assist = True
args.b70_torque_kp = 110.0
args.b70_torque_kd = 1.6
args.b70_max_tau = 1.50
...
args.b99_print = True
print('[B109 CONFIG] corrected joint_id+6 Jacobian + z-only HY/KN projection + small B70 torque assist; HX/XY leakage suppressed; B91/B74/B75/B76 muted')
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B109 Z-ONLY JACOBIAN LIFT + SMALL TORQUE ASSIST planner")
