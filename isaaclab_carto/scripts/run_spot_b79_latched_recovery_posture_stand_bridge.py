...
parser.add_argument("--b79_posture_max_delta", type=float, default=0.035)
parser.add_argument("--b79_posture_kp", type=float, default=18.0)
parser.add_argument("--b79_posture_kd", type=float, default=1.5)
parser.add_argument("--b79_posture_max_tau", type=float, default=6.0)
parser.add_argument("--b79_boost_base_kp_xy", type=float, default=28.0)
parser.add_argument("--b79_boost_base_kd_xy", type=float, default=10.0)
parser.add_argument("--b79_boost_base_z", type=float, default=55.0)
parser.add_argument("--b79_boost_rp", type=float, default=42.0)
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B79 LATCHED RECOVERY POSTURE STAND + B78/B77/B76/B75/B74 planner")
    ...
    for step in range(total_steps):
        ...
        if (bool(getattr(args, "enable_b79_latched_recovery_posture", True))
            ...
            q_nom_active = b79_recovery_q_cmd
            b79_recovery_info = {
                "active": True,
        ...
        if ('b79_recovery_q_cmd' in locals() and b79_recovery_q_cmd is not None
            ...
            tau_b79 = float(args.b79_posture_kp) * (b79_recovery_q_cmd.detach() - q_now_b79) - float(args.b79_posture_kd) * qd_now_b79
            ...
            if bool(getattr(args, "b79_print", True)) and step % max(args.print_every, 1) == 0:
                print("[B79 RECOVERY POSTURE TAU]",
                      "step=", step,
