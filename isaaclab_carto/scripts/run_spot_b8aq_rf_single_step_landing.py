...
#
# B8-aq: RF single-step landing with upright forced release + Jacobian-IK swing adapter.
#
...
parser = argparse.ArgumentParser(description="CARTO/TRACER B8-aq RF single-step landing + Jacobian-IK swing adapter")
...
def print_debug(step, phase, profile, phase_step, x_hat, base_ref, trial_out, ref_mask, contact_mask,
    ...
    print("\n" + "=" * 150)
    print(f"[B8-aq RF-SINGLE-STEP-LANDING] step={step}")
    print("=" * 150)
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B8-aq RF single-step landing + Jacobian-IK swing adapter")
