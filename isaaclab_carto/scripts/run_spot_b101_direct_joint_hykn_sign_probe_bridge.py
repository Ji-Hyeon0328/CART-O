...
# B101 DIRECT JOINT HY/KN SIGN PROBE OVERRIDES
...
args.b99_print = True
print('[B101 CONFIG] direct joint HY/KN sign probe: B70 kept nonsingular; top-level q_target injection during protected pulse; B91/B74/B75/B76 muted')
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B101 DIRECT JOINT HY/KN SIGN PROBE + B99/B98 recovery planner")
