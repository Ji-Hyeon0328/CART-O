...
# B104 READ-ONLY KINEMATIC HY/KN SIGN PROBE OVERRIDES
...
print('[B104 CONFIG] read-only kinematic HY/KN sign probe: no joint target injection, no contact release, print predicted LH foot delta from Jacobian')
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B104 READ-ONLY KINEMATIC HY/KN SIGN PROBE planner")
