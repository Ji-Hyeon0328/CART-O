...
def _b114_print_info(step, info, robot):
    ...
    try:
        ...
        applied = None
    print('[B116 ACTION PATH AUDIT PRE]',
          'step=', step,
...
def _b116_print_post_step(step, pre_info, action_sent, robot):
    ...
    print('[B116 ACTION PATH AUDIT POST]',
          'step=', step,
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B116 ACTION PATH AUDIT RAW EFFORT PROBE (ALL-STANCE, LH HY/KN OVERRIDE) planner")
    ...
    for step in range(total_steps):
        ...
        try:
            ...
            print('[B116 ACTION PATH AUDIT ERROR]', 'step=', step, 'err=', repr(_b114_e))
            b116_action_sent_to_env = tau_cmd.detach().clone()
        ...
        try:
            ...
            print('[B116 ACTION PATH AUDIT POST ERROR]', 'step=', step, 'err=', repr(_b116_post_e))
