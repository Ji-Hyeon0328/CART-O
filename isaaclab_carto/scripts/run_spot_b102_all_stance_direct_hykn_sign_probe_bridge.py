...
# B102 ALL-STANCE DIRECT JOINT HY/KN SIGN PROBE OVERRIDES
...
args.b102_start_step = 140
args.b102_case_steps = 28
args.b102_gap_steps = 10
args.b102_case_index = -1
args.b102_probe_delta = 0.030
...
print('[B102 CONFIG] all-stance direct HY/KN sign probe: no LH contact release; canonical gait delayed; direct q_target injection during standing')
...
def main():
    ...
    print("\n" + "=" * 150)
    print("[INFO] Starting B102 ALL-STANCE DIRECT JOINT HY/KN SIGN PROBE planner")
    ...
    for step in range(total_steps):
        ...
        # B102: all-stance direct HY/KN sign probe.  Unlike B101, this does NOT wait
        # for B95/B99 contact release.  It runs while canonical gait is delayed and all
        # contacts remain closed, so we can observe safe joint/foot/base response.
        ...
        if bool(getattr(args, "enable_b102_all_stance_direct_hykn_sign_probe", False)):
            try:
                ...
                if _in_case:
                    ...
                    _amp = float(getattr(args, "b102_probe_delta", 0.030))
                    ...
                    if not hasattr(globals().get("args"), "_b102_anchor_dummy"):
                        pass
                    # Anchor at the beginning of the whole B102 scan window.
                    if _rel == 0 or ('b102_anchor_w' not in globals()) or globals().get('b102_anchor_w') is None:
                        globals()['b102_anchor_w'] = _foot_w.detach().clone()
                    _anchor = globals().get('b102_anchor_w')
                    _foot_delta = (_foot_w - _anchor).detach()
                    b102_direct_probe_info = {
                        "active": True, "reason": "all_stance_direct_joint_probe",
                    ...
                    if bool(getattr(args, "b102_print", True)):
                        print("[B102 ALL-STANCE DIRECT HY/KN SIGN PROBE]",
                              "step=", step,
